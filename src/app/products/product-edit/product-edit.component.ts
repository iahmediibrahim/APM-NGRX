...
import { getCurrentProduct, State } from '../product-store/product.reducer';
...
export class ProductEditComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.store.pipe(select(getCurrentProduct)).subscribe((currentProduct) => this.displayProduct(currentProduct));
